...
class Testsplit_nodes_delimiter(unittest.TestCase):
    ...
    def test_text_to_text_nodes(self):
        string_input = "This is **text** with an _italic_ word and a `code block` and an ![obi wan image](https://i.imgur.com/fJRm4Vk.jpeg) and a [link](https://boot.dev)"
        test_nodes = [
        ...
        my_nodes = text_to_textnodes(string_input)
        self.assertListEqual(test_nodes,my_nodes)
